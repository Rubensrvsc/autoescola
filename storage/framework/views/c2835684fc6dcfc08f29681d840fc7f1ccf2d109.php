...
<div class="login" >
	<h1><img src="<?php echo e(URL::asset('img/logo.png')); ?>" width="200p"></h1>
    <form method="post" action="<?php echo e(route('usuario.login')); ?>">
		<?php echo csrf_field(); ?>
...
</body></html><?php /**PATH /home/rubens/Downloads/autoescola/resources/views/index.blade.php ENDPATH**/ ?>