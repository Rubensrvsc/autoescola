...
<html lang="pt-br">
    ...
    <body id="page-top">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="<?php echo e(route('instrutores.index')); ?>">Instrutores</a>
                            <a class="collapse-item" href="<?php echo e(route('recep.index')); ?>">Recepcionistas</a>
                            <a class="collapse-item" href="<?php echo e(route('usuarios.index')); ?>">Usuarios</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="<?php echo e(route('categorias.index')); ?>">Categorias</a>
                            <a class="collapse-item" href="<?php echo e(route('veiculos.index')); ?>">Automóveis</a>
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo e($usuario->nome); ?></span>
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                    ...
                                    <a class="dropdown-item" href="<?php echo e(route('usuario.logout')); ?>">
        ...
        <div class="modal fade" id="ModalPerfil" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form id="form-perfil" method="POST" action="<?php echo e(route('admin.editar',$id_usuario)); ?>">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('put'); ?>;
                        <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label >Nome</label>
                                        <input value="<?php echo e($usuario->nome); ?>" type="text" class="form-control" id="nome" name="nome" placeholder="Nome">
                                    </div>

                                    <div class="form-group">
                                        <label >CPF</label>
                                        <input value="<?php echo e($usuario->cpf); ?>" type="text" class="form-control" id="cpf" name="cpf" placeholder="CPF">
                                    </div>

                                    <div class="form-group">
                                        <label >Email</label>
                                        <input value="<?php echo e($usuario->usuario); ?>" type="text" class="form-control" id="usuario" name="usuario" placeholder="Email">
                                    </div>

                                    <div class="form-group">
                                        <label >Senha</label>
                                        <input value="<?php echo e($usuario->senha); ?>" type="text" class="form-control" id="text" name="senha" placeholder="Senha">
                                    </div>
        ...
        <script>src="https://cdnjs.cloudflare.com/ajax/libs/jquery.mask/1.14.11/jquey.mask.min.js"</script>
...
<?php /**PATH /home/rubens/Downloads/autoescola/resources/views/template/painel-admin.blade.php ENDPATH**/ ?>